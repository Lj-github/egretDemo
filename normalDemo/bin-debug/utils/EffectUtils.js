...
(function (EffectUtils) {
    ...
    function rotationEffect(obj, time) {
        ...
        var onComplete1 = function () {
            if (_this.rotationArr[obj.hashCode] && (obj != null)) {
                obj.rotation = 0;
                egret.Tween.get(obj).to({ rotation: 360 }, time).call(onComplete1, _this);
            }
        };
        obj.rotation = 0;
    ...
    function scaleEffect(obj, scale) {
        ...
        egret.Tween.get(obj).to({
            ...
            scaleY: 1,
            alpha: 1
        }, 400, Ease.backIn).wait(500).call(function () {
            obj.visible = false;
        });
    }
    EffectUtils.scaleEffect = scaleEffect;
