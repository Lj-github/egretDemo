...
(function (PopUpManager) {
    ...
    */
    function addPopUp(panel, dark, popUpWidth, popUpHeight, effectType, isAlert, animationType) {
    ...
    function addAnimationShow(panel, dark, popUpWidth, popUpHeight, effectType, isAlert, animationType) {
        if (dark === void 0) { dark = false; }
        if (popUpWidth === void 0) { popUpWidth = 0; }
        if (popUpHeight === void 0) { popUpHeight = 0; }
        if (effectType === void 0) { effectType = 0; }
    ...
    PopUpManager.addAnimationShow = addAnimationShow;
    /**
    * 移除面板方法
    * panel       		面板
    * effectType        0：没有动画 1:从中间缩小消失 2：  3：从左向右 4：从右向左 5、从上到下 6、从下到上
    */
    function removePopUp(panel, effectType, mediator) {
        if (effectType === void 0) { effectType = 0; }
